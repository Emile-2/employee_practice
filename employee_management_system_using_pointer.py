class Employee:
    ...
    def print_all(self):
        print(f"""
              ...
              Month of Birth = {self.month_of_birth},
              Day of Birth = {self.day_of_birth},
              Is Graduated = {self.is_graduated}
              """)

    def update(self, update_attribute):
